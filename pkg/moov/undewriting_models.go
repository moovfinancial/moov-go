...
// UnderwritingV2 will have both v1 and v2 fields for backward compatibility
type UnderwritingV2 struct {
...
type CollectFundsCardPayments struct {
	...
	EstimatedActivity     *EstimatedActivity     `json:"estimatedActivity,omitempty"`
	Fulfillment           *FulfillmentV2         `json:"fulfillment,omitempty"`

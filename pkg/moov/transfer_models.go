...
const (
	...
	CardFailureCode_AccountClosed              CardFailureCode = "account-closed"
	CardFailureCode_AccountNotActivated        CardFailureCode = "account-not-activated"
	CardFailureCode_AuthenticationFailed       CardFailureCode = "authentication-failed"
	CardFailureCode_AuthenticationRequired     CardFailureCode = "authentication-required"
	CardFailureCode_CardholderActionRequired   CardFailureCode = "cardholder-action-required"
	CardFailureCode_FormatError                CardFailureCode = "format-error"
	CardFailureCode_InvalidPin                 CardFailureCode = "invalid-pin"
	CardFailureCode_OfflineApproved            CardFailureCode = "offline-approved"
	CardFailureCode_OfflineDeclined            CardFailureCode = "offline-declined"
	CardFailureCode_PartialApproval            CardFailureCode = "partial-approval"
	CardFailureCode_PaymentStopped             CardFailureCode = "payment-stopped"
	CardFailureCode_PinRequired                CardFailureCode = "pin-required"
	CardFailureCode_RecordNotFound             CardFailureCode = "record-not-found"
	CardFailureCode_SurchargeNotPermitted      CardFailureCode = "surcharge-not-permitted"
	CardFailureCode_TransactionReversed        CardFailureCode = "transaction-reversed"
	CardFailureCode_VerificationFailed         CardFailureCode = "verification-failed"
